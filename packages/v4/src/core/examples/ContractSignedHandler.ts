...
import type { ContractSignedEvent } from "@infrastructure/EventBus/examples/CreateContractSigned.ts";
...
export class ContractSignedHandler implements EventHandler<ContractSignedEvent> {
  ...
  isContractSignedEvent(
    anEvent: DomainEvent | IntegrationEvent | ExternalEvent,
  ): anEvent is ContractSignedEvent {
    return anEvent.type === "createContractSigned";
  }
